! function (e, t) {
    ...
    var t = "Width",
        ...
        s = [],
        c = function () {
            var e, c, l, u, d, f = document.getElementsByClassName("syncscroll");
            for (d in s)
                if (s.hasOwnProperty(d))
                    for (e = 0; e < s[d].length; e++) s[d][e].removeEventListener("scroll", s[d][e].syn, 0);
            for (e = 0; e < f.length; e++)
                if (u = 0, l = f[e], d = l.getAttribute("name")) {
                    for (l = l.scroller || l, s[d] || (s[d] = []), c = 0; c < s[d].length; c++) s[d][c] == l && (u = 1);
                    u || s[d].push(l), l.eX = l.eY = 0,
                        function (e, c) {
                            e.addEventListener("scroll", e.syn = function () {
                                var l, u, d = s[c],
                                    ...
                                    v = 0,
                                    E = 0;
                                for (f != e.eX && (v = 1, e.eX = f), h != e.eY && (E = 1, e.eY = h), u = 0; u < d.length; u++) l = d[u], l != e && (v && (f = Math.round(p * (l[i + t] - l[a + t])), l.eX = l[i + r] = f), E && (h = Math.round(m * (l[i + n] - l[a + n])), l.eY = l[i + o] = h))
                            }, 0)
                        }(l, d)
                }
        };
...
var Timetable = function () {
    this.scope = {
        hourStart: 7,
        hourEnd: 12
    }, this.usingTwelveHour = !1, this.locations = [], this.events = []
};
        ...
        Timetable.prototype = {
            ...
            draw: function (e) {
                ...
                function r(e) {
                    ...
                    var r = (n.firstChild.firstChild.scrollWidth)*v + "px";
                    l(o, r)
                }
                ...
                function i(e) {
                    ...
                    for (var n = t.appendChild(document.createElement("ul")), o = !1, r = !1, i = m.scope.hourStart; !o;) {
                        ...
                        s.className = "time-label", s.textContent = c(i, m.usingTwelveHour), i !== m.scope.hourEnd || m.scope.hourStart === m.scope.hourEnd && !r || (o = !0), 24 === ++i && (i = 0, r = !0)
                    }
                    return t
                }
                ...
                function d(e, t) {
                    ...
                    }), c.className = o ? "time-entry " + e.options["class"] : "time-entry", c.style.width = f(e), c.style.left = p(e), l.textContent = e.name
                }
