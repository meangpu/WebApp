...
public class FirebaseManager : MonoBehaviour
{
    ...
    public void ButtonUpdateUserName()
    {
        StartCoroutine(UpdateUsernameAuth(usernameField.text));
        StartCoroutine(UpdateUsernameDatabase(usernameField.text));
        usernametextDisplay.text = usernameField.text;
    }
    ...
    private IEnumerator Login(string _email, string _password)
    {
        ...
        else
        {
            ...
            usernametextDisplay.text = User.DisplayName;
    ...
    private IEnumerator LoadUserData()
    {
        ...
        else
        {
            ...
            scoreField.text = score.ToString("n0");
        }
    }
   ...
   private IEnumerator GuestLoginFirebase()
    {
        string _guestUser = "guest@gmail.com";
        string _guestPassword =  "1234555";
        string _mainSceneName = "mainGame";

        var LoginTask = auth.SignInWithEmailAndPasswordAsync(_guestUser, _guestPassword);
        yield return new WaitUntil(predicate: () => LoginTask.IsCompleted);
    ...
    {
        StartCoroutine(GuestLoginFirebase());
